...
//     const response = await axios.get(post.videoUrl, { responseType: "stream" });
...
//     console.log(
//       `YouTube video uploaded successfully: ${uploadResponse.data.id}`
//     );
//   } catch (error) {
...
//     // Skip if post doesn't have access token
//     if (!post.ACCESS_TOKEN) {
//       // Generate OAuth URL if no token exists
//       const oauth2Client = new google.auth.OAuth2(
//         post.CLIENT_ID,
//         post.CLIENT_SECRET,
//         "http://localhost:5003/api/callback/account3"
//       );
//       const authUrl = oauth2Client.generateAuthUrl({
//         access_type: "offline",
//         scope: ["https://www.googleapis.com/auth/youtube.upload"],
//         state: post._id.toString(),
//         prompt: "consent",
...
//     const delay = parseInt(post.unixtime) * 1000 - Date.now();
...
//       // If less than 1 hour past scheduled time
//       // Try to upload immediately if slightly past schedule
//       try {
//         await uploadYouTubeVideo(post);
//       } catch (error) {
//         console.error("Failed to upload YouTube video:", error);
